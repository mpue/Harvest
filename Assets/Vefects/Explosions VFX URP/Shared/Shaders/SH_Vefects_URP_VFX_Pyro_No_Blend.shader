...
Shader "Vefects/SH_Vefects_URP_VFX_Pyro_No_Blend"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				// Speed of animation
				float fbspeed82 = input.ase_texcoord9.z * _FlipbookSpeed;
				...
				float3 hsvTorgb4_g5 = RGBToHSV( ( ( input.ase_color * tex2D( _EmissiveLUT, temp_cast_1 ) ) * _EmissiveTint ).rgb );
				...
				float3 Emission = ( temp_output_127_0 * ( ( saturate( hsvTorgb8_g5 ) * input.ase_texcoord9.w ) * _EmissiveMult ) );
				float3 Specular = temp_cast_3;
				float Metallic = 0;
				float Smoothness = _Smoothness;
				float Occlusion = 1;
				float Alpha = saturate( ( temp_output_127_0 * input.ase_color.a ) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float fbrowsoffset82 = 1.0f / _FlipbookRows;
				// Speed of animation
				float fbspeed82 = input.ase_texcoord3.z * _FlipbookSpeed;
				// UV Tiling (col and row offset)
				float2 fbtiling82 = float2(fbcolsoffset82, fbrowsoffset82);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float fbrowsoffset82 = 1.0f / _FlipbookRows;
				// Speed of animation
				float fbspeed82 = input.ase_texcoord4.z * _FlipbookSpeed;
				// UV Tiling (col and row offset)
				float2 fbtiling82 = float2(fbcolsoffset82, fbrowsoffset82);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
				...
				float3 BaseColor = ( _SmokeTint * saturate( tex2DNode83.r ) ).rgb;
				float3 Emission = ( temp_output_127_0 * ( ( saturate( hsvTorgb8_g5 ) * input.ase_texcoord4.w ) * _EmissiveMult ) );
				float Alpha = saturate( ( temp_output_127_0 * input.ase_color.a ) );
				float AlphaClipThreshold = 0.5;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float fbrowsoffset82 = 1.0f / _FlipbookRows;
				// Speed of animation
				float fbspeed82 = input.ase_texcoord2.z * _FlipbookSpeed;
				// UV Tiling (col and row offset)
				float2 fbtiling82 = float2(fbcolsoffset82, fbrowsoffset82);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
		...
		Pass
		{
						 ...
						 )
			{
				...
				float fbrowsoffset82 = 1.0f / _FlipbookRows;
				// Speed of animation
				float fbspeed82 = input.ase_texcoord5.z * _FlipbookSpeed;
				// UV Tiling (col and row offset)
				float2 fbtiling82 = float2(fbcolsoffset82, fbrowsoffset82);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float fbrowsoffset82 = 1.0f / _FlipbookRows;
				// Speed of animation
				float fbspeed82 = input.ase_texcoord.z * _FlipbookSpeed;
				// UV Tiling (col and row offset)
				float2 fbtiling82 = float2(fbcolsoffset82, fbrowsoffset82);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
				...
				surfaceDescription.Alpha = saturate( ( temp_output_127_0 * input.ase_color.a ) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;131;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=685512AE1D79127AFBD02B22F4051442B96B9D28